...
CXXFLAGS += -DDEBUG  -Wall -Wextra -O3 -flto # -ggdb -pg
LDFLAGS = -std=c++2c -fprebuilt-module-path=$(bdir)/ -flto # -ggdb -pg
...
# Test dependencies
$(bdir)/test_pathfind: $(call obj,utils) $(call pcm,common types)
